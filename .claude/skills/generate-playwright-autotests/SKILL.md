---
name: generate-playwright-autotests
description: Generate Playwright autotests for a feature using provided list of test cases. Use when the user wants to create or update Playwright specs, fixtures, page objects, or related test data based on explicit test scenarios.
context: fork
model: sonnet
---
...
- AUTOTEST_REQUEST_URL 
- TARGET_DIR
- TEST_SCENARIOS

Generate Playwright autotests for the list of test scenarios TEST_SCENARIOS.
...
- Put generated autotests script under target directory TARGET_DIR.
